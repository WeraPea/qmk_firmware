 ...
 */
    [_SYM] = LAYOUT(
      KC_GRV , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,                                     KC_LPRN, KC_RPRN, KC_EQL , KC_PIPE, KC_AMPR, _______,
      _______, KC_AT  , KC_DLR , KC_HASH, KC_EXLM, KC_QUES,                                     KC_LBRC, KC_RBRC, KC_MINS, KC_ASTR, KC_PERC, KC_CIRC,
      _______, KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , _______, _______, _______, _______, KC_LCBR, KC_RCBR, KC_PLUS, KC_SLSH, KC_BSLS, _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
 ...
 */
    [_NUMFUN] = LAYOUT(
      ...
      _______, KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , _______, _______, _______, _______, _______, _______, _______, KC_F11 , KC_F12 , _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
 ...
 *
 * ,-------------------------------------------.                              ,-------------------------------------------.
 * |        |      |      |      |ScUp  |      |                              |ScUp  |MCleft|MCmid |MCrght|      |        |
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 * |        |      |MCrght|MCmid |MCleft|      |                              |Mleft |Mdown |Mup   |Mright|      |        |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * |        |      |      |      |ScDn  |      |      |      |  |	   |      |ScDn  |      |      |      |      |        |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 ...
 */
    [_MOUSE] = LAYOUT(
      _______, _______, _______, _______, MS_WHLU, _______,                                     MS_WHLU, MS_BTN1, MS_BTN3, MS_BTN2, _______, _______,
      _______, _______, MS_BTN2, MS_BTN3, MS_BTN1, _______,                                     MS_LEFT, MS_DOWN, MS_UP  , MS_RGHT, _______, _______,
      _______, _______, _______, _______, MS_WHLD, _______, _______, _______, _______, _______, MS_WHLD, MS_ACL0, MS_ACL1, MS_ACL2, _______, _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
    ...
    [_GAMES] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                                 KC_LALT, _______, KC_SPC , _______, _______, _______, _______, _______, _______, _______
    ),
    ...
    [_TOOLS] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______,                                     _______, _______, _______, _______, _______, _______,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                                 _______, _______, ALT_SPC, _______, _______, _______, _______, _______, _______, _______
    ),
 ...
 */
    ...
    [_LEADER] = LAYOUT(
      SH_OS  , KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,                                     _______, _______, _______, _______, _______, _______,
